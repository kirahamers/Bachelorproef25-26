...
\begin{itemize}
    ...
    Hoewel de service momenteel functioneert via scraping, is de architectuur reeds voorbereid met een gecommentarieerde integratielaag voor de officiële (betalende) WSConsultAgentEnterprise-webservice.
