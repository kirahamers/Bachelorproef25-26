...
Daarnaast kan in de toekomst ook gekeken worden naar de integratie van andere vormen van identiteitsverificatie, zoals het gebruik van NFC-technologie, die ervoor kan zorgen dat het scannen van de identiteitskaart sneller, gemakkelijker en gebruiksvriendelijker wordt.
Tot slot is het ook van belang dat de liveness detectie in de toekomst verder wordt verbeterd, aangezien de technologie van deepfakes en gegenereerde beelden realistischer worden, waardoor de huidige liveness-detectie mogelijk niet meer voldoende is om fraude te voorkomen. Het gebruik van gecertificeerde SDK's met geavanceerde liveness-detectie kan hierbij een oplossing bieden.
