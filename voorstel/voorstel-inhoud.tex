...
\begin{itemize}
    \item \textcolor{green}{Hoe verloopt het huidige KYC-proces bij Scrada op het Peppol-platform?}
    \item \textcolor{green}{Welke problemen ervaart Scrada bij het huidige KYC-proces?}
    \item \textcolor{green}{Op welke stappen in het proces kan automatisering toegepast worden?}
    \item \textcolor{green}{Welke technologieën kunnen gebruikt worden om het KYC-proces bij Scrada te automatiseren?}
    \item \textcolor{green}{Welke gegevens van bedrijven worden verzameld tijdens het KYC-proces en hoe gaat Scrada hiermee om?}
    \item \textcolor{green}{Wat zijn de kenmerken van een GDPR-conforme authenticatieprocedure en welke voordelen heeft deze tegenover de huidige methode bij Scrada?}
    \item \textcolor{green}{Welke frauderisico’s bestaan er bij het huidige KYC-proces?}
    \item \textcolor{green}{Welke kosten draagt het huidige KYC-proces bij Scrada?}
\end{itemize}

\subsection{Deelvragen oplossingsdomein} 
\begin{itemize}
    \item \textcolor{orange}{Hoe kunnen de geautomatiseerde KYC-processen conform blijven aan de GDPR-regels?}
    \item \textcolor{orange}{Welke risico’s bestaan bij het verwerken van persoonsgegevens in een geautomatiseerd KYC-proces?}
    \item \textcolor{orange}{Welke maatregelen/technologieën kunnen worden ingezet om fraude bij het geautomatiseerde KYC-proces te voorkomen?}
    \item \textcolor{orange}{Hoe kan automatisering bijdragen aan kostenreductie zonder nadelig te zijn voor GDPR en fraudeveiligheid?}
\end{itemize}
