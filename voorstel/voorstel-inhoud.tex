...
Het doel is om de KYC-doorlooptijd met zeker minimum 50 procent in te korten. Aangezien de automatiseringsoplossing wordt intern ontwikkeld en is afgestemd op de specifieke behoeften van Scrada,
...
\begin{landscape}
    \centering
    \vspace*{1cm}
    \includegraphics[width=0.95\linewidth, height=0.85\textheight, keepaspectratio]{gantt.png}
    
    \vspace{1cm}
    \captionof{figure}{Tijdsplanning geautomatiseerde KYC bij Scrada}
    \label{fig:tijdsplanning}
\end{landscape}
\clearpage % Terug naar portrait-modus en nieuwe pagina