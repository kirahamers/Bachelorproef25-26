...
\begin{itemize}
  ...
  Documenteren van het huidige proces bij Scrada, onderzoeken waar automatisatie of verbetering kan toegepast worden rekening houdend met efficiëntie, fraudeveiligheid en GDPR. \\
  \emph{Deliverable: beschrijving van het huidige proces bij Scrada en probleemidentificatie, rekening houdend met de mogelijke oplossingen vanuit de literatuurstudie (Welke zou het best passen?).}
  ...
  \emph{Deliverable: requirementsdocument.}
  ...
  \emph{Deliverable: beoordeling van de resultaten van de automatisering.}
